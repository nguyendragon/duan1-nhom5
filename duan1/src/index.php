...
<head>
  ...
  <body>
                ...
                <div class="card pb-0 o-hidden earning-card">
                  ...
                  <div class="card-body p-0">
                    <div class="earning-content" style="margin-top: 40px;">
                      ...
                      <h6 style="font-size: 24px;">573.672.238đ</h6>
                      ...
                      <div class="col-sm-6">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            ...
                            <div class="media-body">
                              <h6>Hôm nay</h6>
                              <h5>$<span class="counter">25698</span><span class="font-danger">-36%($2658)</span></h5>
                      ...
                      <div class="col-sm-6">
                        <div class="widget-card">
                          <div class="media align-self-center">
                            ...
                            <div class="media-body">
                              <h6>Tháng</h6>
                              <h5>$<span class="counter">6954</span><span class="font-danger">-15%($369) </span></h5>
              ...
              <div class="col-sm-12">
                <div class="card browser-table">
                  <div class="card-header">
                    <div class="media">
                      <div class="media-body">
                        <h5>Sử dụng trong trình duyệt</h5>
                      </div>
                      <div class="icon-box onhover-dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
                        <div class="icon-box-show onhover-show-div">
                          <ul> 
    ...
    <?php include_once "../layout/library_script.php" ?>
  </body>
</html>