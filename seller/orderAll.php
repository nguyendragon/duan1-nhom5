                                        ...
                                        <table class="display" id="responsive">
                                            ...
                                            foreach ($data as $key => $value) { ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td style="min-width: 150px;" class="text-<?=$value['status_order'] == 5 ? 'danger' : 'success'?>">
                                                        <?php if ($value['status_order'] == 1) echo "Đã giao"; ?>
                                                        <?php if ($value['status_order'] == 3) echo "Đang giao hàng"; ?>
                                                        <?php if ($value['status_order'] == 5) echo "Đã hủy"; ?>
                                                    </td>
                                                    <td><?= date("d M Y, H:i a", $value['time']) ?></td>
                                                    <td>
                                                        <?php if ($value['status_order'] == 0) { ?>
                                                            <a href="models/order.php?type=update&id_order=<?= $value['id_order'] ?>" class="btn-primary delete-btn p-2" title="">Xác nhận</a>
                                                        <?php } ?>
                                                        <!-- <a 
