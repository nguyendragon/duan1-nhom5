...
<?php
$data = $dragon->Statistical();
foreach ($data['top_products'] as $key => $value) {
    print_r($value);
}
?>
                        ...
                        <div class="col-xl-3 col-md-6 dash-xl-50">
                            <div class="card pb-0 o-hidden earning-card">
                                ...
                                <div class="card-body p-0">
                                    <div class="earning-content" style="margin-top: 40px;">
                                        <a href="blog-single.html">
                                            <h4>Thu nhập hôm nay</h4>
                                        </a>
                                        <h6 style="font-size: 24px;"><?= $dragon->money($data['today_money'], '.') ?>đ</h6>
                                        <div id="earning-chart" style="min-height: 120px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card o-hidden">
                                <div class="card-body">
                                    <div class="media static-widget">
                                        <div class="media-body">
                                            <h6 class="font-roboto">Thu nhập</h6>
                                            <h4 class="mb-0 counter"><?= $dragon->money($data['total_money'], '.') ?></h4>
                                        </div>
                        ...
                        <div class="col-sm-6 col-xl-3 col-lg-6">
                            <div class="card o-hidden">
                                <div class="card-body">
                                    <div class="media static-widget">
                                        <div class="media-body">
                                            <h6 class="font-roboto">Các sản phẩm</h6>
                                            <h4 class="mb-0 counter"><?= $dragon->money($data['total_product'], '.') ?></h4>
                                        </div>
                        ...
                        <div class="col-sm-6 col-xl-3 col-lg-6">
                            <div class="card o-hidden">
                                <div class="card-body">
                                    <div class="media static-widget">
                                        <div class="media-body">
                                            <h6 class="font-roboto">Tin nhắn</h6>
                        ...
                        <div class="col-sm-6 col-xl-3 col-lg-6">
                            <div class="card o-hidden">
                                <div class="card-body">
                                    <div class="media static-widget">
                                        <div class="media-body">
                                            <h6 class="font-roboto">Thành viên mới</h6>
                                            ...
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Đơn hàng mới</h6>
                                                        <h5>
                                                            <?= $dragon->money($data['order_new'], '.') ?>
                                                            <span class="font-roboto font-success f-w-700">
                                                                <i class="icofont icofont-arrow-up"></i> 68%</span>
                                                        </h5>
                                                        <div class="icon-bg">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Danh sách hàng chờ</h6>
                                                        <h5><?= $dragon->money($data['order_wait'], '.') ?><span class="font-roboto font-danger f-w-700"><i class="icofont icofont-arrow-down"></i> 12%</span></h5>
                                                    </div>
                                                </div>
                                                <div class="icon-bg">
                                            ...
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <h5><?= $dragon->money($data['order_done'], '.') ?><span class="font-roboto font-success f-w-700"><i class="icofont icofont-arrow-up"></i> 50%</span></h5>
                                                    </div>
                                                </div>
                                                <div class="icon-bg">
                                            ...
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <h5><?= $dragon->money($data['order_cannel'], '.') ?><span class="font-roboto font-success f-w-700"><i class="icofont icofont-arrow-up"></i> 20%</span></h5>
                                                    </div>
                                                </div>
                                                <div class="icon-bg">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="icon-box onhover-dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal">
                                            ...
                                            <div class="icon-box-show onhover-show-div">
                                                <ul>
                                                    <li>
                                                        <a data-bs-original-title="" title="">Done</a>
                                                    </li>
                                                    <li>
                                                        <a data-bs-original-title="" title="">Pending</a>
                                                    </li>
                                                    <li>
                                                        <a data-bs-original-title="" title="">Rejected</a>
                                                    </li>
                                                    <li>
                                                        <a data-bs-original-title="" title="">In Progress</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Hôm nay</h6>
                                                        <h5>
                                                            <span class=""><?= $dragon->money($data['today_order'], '.') ?></span> đơn
                                                            <!-- <span class="font-danger">-36%($2658)</span> -->
                                                        </h5>
                                                        <span class="font-roboto">Hơn hôm qua</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Tháng</h6>
                                                        <h5><span class=""><?= $dragon->money($data['month_order'], '.') ?></span> đơn
                                                            <!-- <span class="font-danger">-15%($369) </span> -->
                                                        </h5>
                                                        <span class="font-roboto"> Hơn tháng trước</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Tuần</h6>
                                                        <h5>
                                                            <span class=""><?= $dragon->money($data['week_order'], '.') ?></span> đơn
                                                            <!-- <span class="font-danger">-15%($369) </span> -->
                                                        </h5>
                                                        <span class="font-roboto">Hơn tuần trước</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Năm</h6>
                                                        <h5 class="text-success">Chưa có thống kê</h5>
                                                        <span class="font-roboto">Hơn tháng trước</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Hôm nay</h6>
                                                        <h5>
                                                            <span class="counter"><?= $dragon->money($data['today_money'], '.') ?></span> đ
                                                            <!-- <span class="font-danger">-36%($2658)</span> -->
                                                        </h5>
                                                        <span class="font-roboto">Hơn hôm qua</span>
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Tháng</h6>
                                                        <h5><span class="counter"><?= $dragon->money($data['month_money'], '.') ?></span> đ
                                                            <!-- <span class="font-danger">-15%($369) </span> -->
                                                        </h5>
                                                        <span class="font-roboto"> Hơn tháng trước</span>
                                                    </div>
                                            ...
                                            <div class="widget-card">
                                                <div class="media align-self-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h6>Tuần</h6>
                                                        <h5>
                                                            <span class="counter"><?= $dragon->money($data['week_money'], '.') ?></span> đ
                                                            <!-- <span class="font-danger">-15%($369) </span> -->
                                                        </h5>
                                                        <span class="font-roboto">Hơn tuần trước</span>
                                                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card browser-table">
                                <div class="card-header">
                                    <div class="media">
                                        <div class="media-body">
                                            <h5>Top 3 sản phẩm bán chạy nhất</h5>
                                        </div>
                                        <div class="icon-box onhover-dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal">
                                                <circle cx="12" cy="12" r="1"></circle>
                                                <circle cx="19" cy="12" r="1"></circle>
                                    ...
                                    <div class="table-responsive mb-0">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $data = $dragon->Statistical();
                                                foreach ($data['top_products'] as $key => $value) {
                                                    $product = $dragon->productById($value['id_product']); ?>
                                                    <tr>
                                                        <td>
                                                            <img 
                                                                style="width: 120px;height: 120px;" 
                                                                src="<?=BASE_URL.'/assets/upload/'.$product['image']?>" alt=""
                                                            >
                                                        </td>
                                                        <td class="text-success"><?= $product['name_product'] ?></td>
                                                        <td class="text-danger"><?= $dragon->money($product['price'], '.') ?>đ</td>
                                                        <td class="text-danger"><?= $dragon->money($product['sale'], '.') ?>đ</td>
                                                        <td><?= $dragon->money($value['total'], '.') ?> đơn</td>
                                                    </tr>
                                                <?php } ?>
                                                <?php if ($data['top_products']->num_rows == 0) : ?>
                                                    <tr class="text-center bg-light">
                                                        <td class="p-2" colspan="5">Chưa có dữ liệu</td>
                                                    </tr>
                                                <?php endif ?>
                                            </tbody>
                                        </table>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 footer-copyright text-center">
                            <p class="mb-0">Copyright 2022 © Zeta theme by Pixel Strap</p>
                        </div>
                    </div>
                </div>
            </footer>
